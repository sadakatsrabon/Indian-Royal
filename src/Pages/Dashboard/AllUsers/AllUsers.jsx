...
const AllUsers = () => {
    ...
    const handleMakeAdmin = (user) => {
        fetch(`https://server-indian-royal-52pijzpld-sadakatsrabon.vercel.app/users/admin/${user._id}`, {
            method: 'PATCH'
        })
            .then(res => res.json())
            .then(data => {
...
// //     const {data: users=[], refetch} = useQuery(['users'], async ()=> {
// //         const res = await fetch('https://server-indian-royal-52pijzpld-sadakatsrabon.vercel.app/users')
// //         return res.json;
// //     } )
// //     return (
// //         <div>
