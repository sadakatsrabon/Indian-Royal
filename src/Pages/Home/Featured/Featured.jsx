...
const Featured = () => {
    return (
        <div className='featured-item bg-fixed text-white pt-8 my-20'>
            <SectionTitle heading="Royal Room Booking"></SectionTitle>
            <div className='md:flex justify-center items-center bg-slate-600 bg-opacity-70 pt-20 pb-12 px-8 md:px-36'>
                ...
                <div className='md:ml-10'>
                    ...
                    <p className='uppercase text-lg text-yellow-400 bg-slate-400 bg-opacity-30 rounded-lg p-2'>where can i get a rest house?</p>
