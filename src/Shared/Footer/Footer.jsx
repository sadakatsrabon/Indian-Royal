        ...
        <div>
            <footer className="footer p-10 bg-neutral text-neutral-content justify-around">
                <aside className='m-auto'>
                    <img className='w-48 border-b gap-4' src={logo} alt="" />
                    <p className=' text-center mx-auto text-xl'>Royal Indian Restaurent</p>
                    <p className='mx-auto text-xs'>Providing halal foods since 2015</p>
                </aside>
                <nav className='m-auto'>
                    <header className="footer-title mx-auto ">Contact Information</header>
                    ...
                    <button className='mx-auto btn btn-sm btn-outline text-white'><Link to="/contact">Contact Us</Link> </button>
                </nav>
